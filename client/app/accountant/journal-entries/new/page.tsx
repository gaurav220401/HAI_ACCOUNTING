        ...
        <PageHeader
          breadcrumb={
            <span className="flex flex-col text-left">
              ...
              <span className="text-sm font-semibold text-slate-700 mt-0.5">New Journal Entry</span>
            </span>
          }
        />
        ...
        <Dialog open={settingsOpen} onOpenChange={setSettingsOpen}>
          <DialogContent className="sm:max-w-xl">
            ...
            <div className="space-y-4">
             ...
             <DialogFooter>
              <Button variant="outline" className="border-slate-200 text-slate-600 bg-white hover:bg-slate-50 rounded-md" onClick={() => setSettingsOpen(false)}>
                Cancel
              </Button>
              <Button
