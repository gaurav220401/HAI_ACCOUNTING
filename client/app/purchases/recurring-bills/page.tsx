    ...
    <SidebarProvider>
      ...
      <SidebarInset className="bg-gray-50/50">
        ...
        <div className="flex h-[calc(100vh-120px)] border-t">
          <div className="w-[380px] border-r bg-white overflow-y-auto">
              ...
              {recs.map((rec) => (
                ...
                >
                  <div className="flex items-start justify-between gap-2">
                    <div>
                      <div className="text-sm font-semibold text-gray-800">{getName(rec.vendorId) || "Vendor"}</div>
                      <div className="text-xs text-blue-600">{rec.profileName}</div>
                      <div className="text-xs text-muted-foreground mt-1">{freqLabel(rec)}</div>
                      <div className="text-xs text-muted-foreground">Next Bill on {fmtDate(rec.nextBillDate)}</div>
                    </div>
                    <div className="text-right">
                      <div className="text-sm font-bold">{fmtCurrency(rec.total || 0)}</div>
                      <div className={cn(
                        "text-[10px] uppercase font-bold mt-1",
                        rec.status === "Active" ? "text-green-600" : rec.status === "Stopped" ? "text-orange-600" : "text-gray-500"
                      )}>
                        {rec.status}
                      </div>
                    </div>
                ...
                {activeTab === "overview" ? (
                  <div className="mt-4 grid grid-cols-3 gap-4 text-sm">
                    <div className="col-span-1 border rounded-lg p-4">
                      ...
                      <div className="font-semibold text-blue-600">{getName(selectedRec.vendorId)}</div>
                    </div>
                    <div className="col-span-1 border rounded-lg p-4">
                    ...
                    <div className="col-span-2 border rounded-lg p-4">
                      ...
                      <div className="mt-2 space-y-2">
                        ...
                        <div className="flex items-center justify-between text-sm">
                          <span className="text-muted-foreground">Recurring Period</span>
                          <span>{freqLabel(selectedRec)}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="col-span-3 mt-2">
                      <div className="flex items-center justify-between">
                        ...
                        <Button variant="ghost" size="sm" className="text-xs">All Child Bills</Button>
                      </div>
