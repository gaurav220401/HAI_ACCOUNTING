          ...
          <form onSubmit={handleSubmit} className="max-w-5xl mx-auto space-y-6">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <Button
                ...
                onClick={() => router.back()}
                disabled={submitting}
                className="px-6 border-slate-200 text-slate-600 bg-white hover:bg-slate-50 rounded-md"
              >
                Cancel
              </Button>
            </div>
        ...
        <PageHeader
          breadcrumb={
            <div className="flex flex-col">
              ...
              <span className="text-sm font-semibold text-slate-700">New Recurring Expense</span>
            </div>
          }
        />
